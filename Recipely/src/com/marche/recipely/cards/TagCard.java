...
public class TagCard extends Card {
	...
	public TagCard(Context context, Recipe recipe) {
		this(context, R.layout.tag_content);
		this.recipe = recipe;
		this.context = context;
	}

	public TagCard(Context context, int innerLayout) {
	...
	public void setupInnerViewElements(ViewGroup parent, View view) {
		...
		for(int i = 0; i<recipe.ingredients.size(); i++){
			TagChip ingre = new TagChip(context, recipe.tags.get(i));
			row.addView(ingre);
		}
	}
}
